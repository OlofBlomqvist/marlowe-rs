...
export function transactionbuilder_add_change_if_needed(a: number, b: number, c: number): void;
...
export function transactionbuilder_min_fee(a: number, b: number): void;
export function __wbg_txredeemerbuilder_free(a: number): void;
export function txredeemerbuilder_build(a: number, b: number): void;
export function txredeemerbuilder_add_temporary_required_signer(a: number, b: number): void;
