...
export function wasmmarlowestatemachine_create(a: number, b: number, c: number): void;
export function wasmmarlowestatemachine_contract(a: number): number;
export function wasmmarlowestatemachine_logs(a: number, b: number): void;
...
export function wasmmarlowestatemachine_expected_inputs_json(a: number, b: number): void;
...
export function __wbg_set_wasmstate_min_time(a: number, b: number): void;
...
export function __wbg_get_wasmstate_min_time(a: number): number;
