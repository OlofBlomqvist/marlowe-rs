...
export function __wbg_get_bound_0(a: number, b: number): void;
export function __wbg_set_bound_0(a: number, b: number, c: number): void;
export function __wbg_get_bound_1(a: number, b: number): void;
export function __wbg_set_bound_1(a: number, b: number, c: number): void;
...
export function __wbg_set_wasmaccount_amount(a: number, b: number, c: number): void;
export function __wbg_set_wasmchoice_value(a: number, b: number, c: number): void;
export function __wbg_set_wasmboundvalue_value(a: number, b: number, c: number): void;
export function __wbg_set_wasmstate_min_time(a: number, b: number, c: number): void;
export function __wbg_get_wasmboundvalue_value(a: number, b: number): void;
export function __wbg_get_wasmchoice_value(a: number, b: number): void;
export function __wbg_get_wasmstate_min_time(a: number, b: number): void;
export function __wbg_get_wasmaccount_amount(a: number, b: number): void;
export function __wbg_get_wasmchoice_choice_name(a: number, b: number): void;
export function list_inputs_params(a: number, b: number, c: number): void;
